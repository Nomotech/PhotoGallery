...
function mode_select(){
	if(key[48] == 1){//0
		if(mode*10%10==0){
			camera_keep = new THREE.Vector3(camera.position.x,camera.position.y,camera.position.z);
			premode = mode;
			transcounter=0;
		}
		switch(mode){
			...
			case 2: mode = 0.2; break;
			case 3: mode = 0.2; break;
			case 4: mode = 0.2; break;
			case 5: mode = 0.2; break;
			default: break;
		}
		selectmenu = 0;
	}
		...
		switch(mode){
			case 0: mode = 1.1; break;
			case 1: 			break;
			case 2: mode = 1.2; break;
			case 3: mode = 1.2; break;
			case 4: mode = 1.2; break;
			case 5: mode = 1.2; break;
			default: break;
		}
		selectmenu = 0;
	}
		...
		switch(mode){
			case 0: mode = 2.1; break;
			case 1: mode = 2.2; break;
			case 2: 			break;
			case 3: mode = 2.2; break;
			case 4: mode = 2.2; break;
			case 5: mode = 2.2; break;
			default: break;
		}
		selectmenu = 0;
	}
		...
		switch(mode){
			case 0: mode = 3.1; break;
			case 1: mode = 3.1; break;
			case 2: mode = 3.1; break;
			case 3: 			break;
			case 4: mode = 3.1; break;
			case 5: mode = 3.1; break;
			default: break;
		}
		selectmenu = 0;
	}
		...
		switch(mode){
			case 0: mode = 4.1; break;
			case 1: mode = 4.2; break;
			case 2: mode = 4.2; break;
			case 3: mode = 4.1; break;
			case 4: 			break;
			case 5: mode = 4.1; break;
			default: break;
		}
		selectmenu = 0;
	}
		...
		switch(mode){
			case 0: mode = 5.1; break;
			case 1: mode = 5.1; break;
			case 2: mode = 5.2; break;
			case 3: mode = 5.1; break;
			case 4: mode = 5.1; break;
			case 5: 			break;
			default: break;
		}
		selectmenu = 0;
...
function mode_change(){
	switch(mode){
		case 0.1:
			...
			if(selectdir>=0)dir[selectdir].object.scale.set(1,1,1);
			break;
		case 0.2:
		...
		case 1.1:
			...
			if(selectdir>=0)dir[selectdir].object.scale.set(0.00001,0.00001,0.00001);
			break;
		case 1.2:
...
function card_select(){
	...
	if(i==forcuscard_m||i==forcuscard_hr){
		...
		//card[i].frame_mesh.material.map = card[i].texture3;
		...
		//card[i].frame_mesh.material.map = card[i].texture1;
	}
	...
	if(i==pre_selectcard){
		card[i].r = card[i].mode_r[6] - (card[i].mode_r[6] - card[i].mode_r[Math.floor(mode)]) * easeOutBack(pre_selectcounter/transtime);
		//card[i].card.rotation.x = card[i].mode_rot[premode][0] + (card[i].mode_rot[premode][0]-card[i].mode_rot[1][0]) * transcounter/transtime; 
		card[i].card.rotation.z = card[i].mode_rot[6][2] + (card[i].mode_rot[Math.floor(mode)][2]-card[i].mode_rot[6][2]) * easeOutExpo(pre_selectcounter/transtime);
		card[i].card.rotation.y = card[i].mode_rot[6][1] + ((card[i].mode_rot[Math.floor(mode)][1]-card[i].mode_rot[6][1] + Math.PI)%(2*Math.PI) - Math.PI) * easeOutExpo(pre_selectcounter/transtime);
